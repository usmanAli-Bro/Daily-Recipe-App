...
class FavoriteItem extends StatefulWidget {
  final itemColor;
  FavoriteItem({@required this.itemColor});
...
class _FavoriteItemState extends State<FavoriteItem> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
            ...
            IconButton(
                onPressed: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => NotifyActionClass()));
                },
                icon: Icon(
      ...
      body: FavoritItemDetail(),
    );
  }
}

class FavoritItemDetail extends StatelessWidget {
  const FavoritItemDetail({Key key}) : super(key: key);
